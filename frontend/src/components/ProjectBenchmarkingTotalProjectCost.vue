...
<template>
  <div class="project-benchmarking-total-project-cost">
    <span class="card-subtitle">Total Project Cost (P90 Outturn)</span>
    <div class="project-benchmarking-total-project-cost__card-content">
...
.project-benchmarking-total-project-cost {
  flex: 1;
  display: flex;
