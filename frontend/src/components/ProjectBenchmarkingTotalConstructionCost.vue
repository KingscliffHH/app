    ...
    data: {
      ...
      datasets: [
        ...props.data.map((d, i) => {
          return {
            label: d.name,
            data: [d.totalConstructionCostPerLaneKm],
            borderRadius: 5,
            barPercentage: 0.7,
            maxBarThickness: 25,
...
<template>
  <div class="project-benchmarking-total-construction-cost">
    <span class="card-subtitle">Cost/Lane KM (Total Construction)</span>
    <div class="project-benchmarking-total-construction-cost__card-content">
...
.project-benchmarking-total-construction-cost {
  flex: 1;
  display: flex;
