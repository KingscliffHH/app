    ...
    data: {
      ...
      datasets: [
        ...props.data.map((d, i) => {
          return {
            label: d.name,
            data: [d.cubicMetreRateForEarthworksPerM3],
            borderRadius: 5,
            barPercentage: 0.7,
            maxBarThickness: 25,
...
<template>
  <div class="project-benchmarking-m3-rate-for-earth-works">
    <span class="card-subtitle">Earthworks (Cost/M3)</span>
    <div class="project-benchmarking-m3-rate-for-earth-works__card-content">
...
.project-benchmarking-m3-rate-for-earth-works {
  flex: 1;
  display: flex;
